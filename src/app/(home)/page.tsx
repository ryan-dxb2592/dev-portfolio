...
export default function Home() {
  ...
  return (
    <>
      <main className="min-h-screen text-secondary-foreground">
        <section className="relative min-h-screen flex items-center">
          <GridBackground gridColor="#94a3b8" gridOpacity={10} gridSize={40} />

          <div className="container flex flex-col pt-24 lg:pt-0 pb-10 lg:flex-row mx-auto px-4 space-y-1 gap-x-10 gap-y-16 justify-center items-center">
            {/* Left Side */}
